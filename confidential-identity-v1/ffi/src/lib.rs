...
use confidential_identity_v1::{build_scope_claim_proof_data, compute_cdd_id, compute_scope_id};

pub type ScopeClaimData = confidential_identity_v1::ScopeClaimData;
pub type ScopeClaimProofData = confidential_identity_v1::ScopeClaimProofData;
pub type ProofPublicKey = confidential_identity_v1::ProofPublicKey;
pub type ProofKeyPair = confidential_identity_v1::ProofKeyPair;
pub type CddClaimData = confidential_identity_v1::CddClaimData;
