...
use curve25519_dalek::{
    ...
    constants::RISTRETTO_BASEPOINT_POINT, constants::RISTRETTO_BASEPOINT_COMPRESSED,
...
mod tests {
    ...
    static V1_BYTES: [u8; 32] = [
        0x7e, 0x5e, 0x6d, 0x42, 0xa0, 0xef, 0xc9, 0xcd,
        0x11, 0xad, 0x6d, 0x3f, 0x74, 0x6, 0x97, 0xf5,
        0x6d, 0x5f, 0xb8, 0xad, 0x5f, 0xf4, 0xbb, 0x6f,
        0xdf, 0x3f, 0xb4, 0xf2, 0x4a, 0x8e, 0x57, 0xa ];

    static V2_BYTES: [u8; 32] = [
        0xe7, 0xee, 0x1, 0x77, 0x67, 0xf2, 0x9e, 0x5a,
        0xa7, 0x17, 0x98, 0xa7, 0xbc, 0x9b, 0xd4, 0xc,
        0xe, 0x4e, 0xd8, 0xeb, 0xf6, 0xa, 0xa3, 0x3d,
        0x7a, 0xc6, 0x78, 0xda, 0x28, 0xd4, 0x20, 0x3 ];
    ...
    fn default_generators() {
        let expected_g0 = [
            0x90, 0x6b, 0xff, 0x34, 0x42, 0x25, 0x5f, 0xd9,
            0x2c, 0xf0, 0x2d, 0xad, 0x4c, 0x86, 0xec, 0xff,
            0x3e, 0x8b, 0xc4, 0x6, 0x9e, 0xe5, 0x49, 0xc5,
            0xc3, 0x98, 0xf0, 0x9c, 0x28, 0x8a, 0x4e, 0x5d, ];
        let expected_g1 = [
            0xbe, 0xda, 0x2, 0x0, 0x86, 0xbd, 0x74, 0x8f,
            0xef, 0x9, 0x28, 0xf2, 0xa3, 0xca, 0x14, 0x51,
            0xc0, 0x9d, 0xde, 0x4d, 0x9a, 0xb5, 0x32, 0x45,
    ...
    fn fixed_label_prime() {
        let expected_commit_result_prime = [
            0xdc, 0xc6, 0x18, 0x1f, 0x65, 0x4d, 0xdf, 0x28,
            0x41, 0xb2, 0xd9, 0x57, 0x8d, 0xd0, 0x47, 0xa1,
