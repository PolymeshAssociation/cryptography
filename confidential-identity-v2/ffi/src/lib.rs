...
pub type ScopeClaimData = confidential_identity_v2::ScopeClaimData;
pub type CddClaimData = confidential_identity_v2::CddClaimData;
pub type CddId = confidential_identity_v2::CddId;
