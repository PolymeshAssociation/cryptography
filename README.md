...
This library implements the essential Zero-Knowledge Proofs that are used in the MERCAT library.
For more details see section 5 of the MERCAT whitepaper.
...
This repository also holds a set CLI tools that provide various ways of using this library.
